...
STREAMLINED_FUNCTION_PROMPT_CONFIG = PromptConfig(OPTIMIZED_FUNCTION_PROMPT, CoTFunctionDocstringAssessment)
STREAMLINED_CLASS_PROMPT_CONFIG = PromptConfig(OPTIMIZED_CLASS_PROMPT, CoTClassDocstringAssessment)
